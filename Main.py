...
main = Tk()
main.title("CLASSIFICATION OF PULMONARY DISEASES USING COUGH SOUNDS")
w = main.winfo_screenwidth()
h = main.winfo_screenheight()
main.geometry("1300x1200")

#Loading image using PIL and ImageTk
my_image=ImageTk.PhotoImage(Image.open("C:/Users/kotek/OneDrive/Desktop/Project.jpg"))
...
font = ('times', 18, 'bold')
title =Label(main,text='CLASSIFICATION OF PULMONARY DISEASES USING COUGH SOUNDS')
